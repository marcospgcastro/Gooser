...
const host = '127.0.0.1';                                                         // Host local, onde é exibido o status de funcionamento.
...
status.listen(port, host, () => { 
    console.log(' Gooser está "dockerizado" - Setado em http://'+host+':'+port) // Retorna ao usuário host:porta onde é exibido status de execução.                                   
